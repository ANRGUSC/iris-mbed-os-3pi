//Magnetometer class to communicate between MBED and LIS3MDL magnetometer
...
class LIS3MDL
{
  ...
  private:
    ...
    uint8_t address;  //address of LIS3MDL on chip
